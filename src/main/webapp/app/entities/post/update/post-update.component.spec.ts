...
describe('Post Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Blog query and add missing value', () => {
      ...
      const blog: IBlog = { id: 30074 };
      post.blog = blog;

      const blogCollection: IBlog[] = [{ id: 19024 }];
    ...
    it('Should call Tag query and add missing value', () => {
      const post: IPost = { id: 456 };
      const tags: ITag[] = [{ id: 18116 }];
      post.tags = tags;

      const tagCollection: ITag[] = [{ id: 30003 }];
    ...
    it('Should update editForm', () => {
      const post: IPost = { id: 456 };
      const blog: IBlog = { id: 26468 };
      post.blog = blog;
      const tag: ITag = { id: 28989 };
      post.tags = [tag];
